...
/**
 * POST /api/workspace/generate-topics-prompts
 * Asynchronously generates topics and prompts for a workspace region
 * Body: { workspaceId: string, regionId: string, brandName: string, brandDescription: string, region: string, language: string }
 */
